export const listaProjetos = [
  ...
  },
  {
    id: 18,
    titulo: "I Weather",
    descricao: "Uma aplicação React Native que fornece informações meteorológicas em tempo real. Aplicação de testes unitários e automatizados ",
  ...
  },
  {
    id: 10,
    titulo: "Teams",
    descricao: "Aplicativo mobile para gerenciamento de times e eventos, é possível criar turmas de jogos e atividades e dividir pessoas entre as duas turmas",
  ...
  },
  {
    id: 6,
    titulo: "To do List",
    descricao: "Lista de tarefas para facilitar e organizar as atividades diárias, com opções de adicionar, remover e marcar como concluída.",
